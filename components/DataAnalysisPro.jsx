      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">Learn statistics, SQL, Python, visualization, ethics, and agentic AI through focused theory notes, curated video searches, quiz practice, and project prompts.</p>
          ...
          <Card className="shadow-xl">
            ...
            <h3 className="mt-1 text-3xl font-black">{totalProgress}% overall progress</h3>
            <div className="mt-5 h-3 overflow-hidden rounded-full bg-slate-200">
              <div className="h-full rounded-full bg-slate-950" style={{ width: `${totalProgress}%` }} />
            </div>
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <div className="rounded-2xl bg-slate-100 p-4 text-center"><div className="text-3xl font-black">18</div><div className="text-sm text-slate-500">Videos</div></div>
        ...
        <section id="topics" className="mt-10 grid gap-6 lg:grid-cols-[1fr_320px]">
          <Card>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <label className="mt-4 block text-sm text-slate-600">Daily goal: {dailyGoal} minutes</label>
              <input type="range" min="15" max="120" step="15" value={dailyGoal} onChange={(event) => setDailyGoal(Number(event.target.value))} className="mt-3 w-full" />
